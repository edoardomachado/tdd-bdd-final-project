...
class TestProductRoutes(TestCase):
    ...
    def test_query_by_name(self):
        ...
        data = response.get_json()
        # assert that the length of the data list (i.e., the number of
        # products returned in the response) is equal to name_count
    ...
    def test_query_by_category(self):
        ...
        # of products returned in the response) is equal to found_count
        self.assertEqual(len(data), found_count)
        # use a for loop to check each product in the data list and verify
        # that all returned products belong to the queried category
        for product in data:
    ...
    def test_query_by_availability(self):
        ...
        products = self._create_products(10)
        # list named available_products is initialized to store the products
        # based on their availability status
