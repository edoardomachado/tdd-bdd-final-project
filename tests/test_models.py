...
class TestProductModel(unittest.TestCase):
    ...
    def test_to_find_by_availability(self):
        """ It should Find a product by availability"""
        products = ProductFactory.create_batch(10)
        # Use a for loop to iterate over the products list and call the create() method on
        # each product to save them to the database.
        for product in products:
            product.create()
    ...
    def test_to_find_by_category(self):
        ...
        # Use a list comprehension to filter the products based on their category and
        # then use len() to calculate the length of the filtered list, and use the variable
        # called count to hold the number of products that have the specified category.
    ...
    def test_to_find_by_price(self):
        ...
        # the number of products that have the specified price.
        ...
        # matches the expected price, to ensure that all the retrieved products have the correct price
        for product in found:
            self.assertEqual(product.price, price)

    def test_serialize_into_dictionary(self):
    ...
    def test_deserialize_from_dictionary(self):
    ...
    def test_without_id(self):
        """ It should test account update without id"""
        product = ProductFactory()
        product.id = None
        self.assertRaises(DataValidationError, product.update)

    def test_deserialize_when_invalid_type_boolean(self):
        """ It should test raises exception when invalid type for boolean"""
        data = {
            "name": "Laptop",
    ...
    def test_deserialize_when_missing_atribute(self):
        """ It should raises exception when missing atribute"""
        data = {
            "name": "Laptop",
            "description": "A powerful laptop",
            "price": "1200.99",
    ...
    def test_deserialize_when_bad_data(self):
        """ It should raises exception when bad data"""
        product = Product()
        with self.assertRaises(DataValidationError):
            product.deserialize("")

    def test_deserialize_when_invalid_atribute(self):
        """ It should raises exception when invalid atribute"""
        data = {
            "name": "Laptop",
            "description": "A powerful laptop",
            "price": "1200.99",
